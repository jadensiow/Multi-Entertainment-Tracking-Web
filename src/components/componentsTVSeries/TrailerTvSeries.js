...
export const TrailerTvSeries = (props) => {
  // console.log(props.tvseries);

  //AIzaSyD3wEZ8-YIeLR747RyCYclfDBOzjBnk6hs limit

  let search = `${props.tvseries.name}`;
  let yearOfrelease = props.tvseries.first_air_date
    ? props.tvseries.first_air_date.slice(0, 4)
    : "";
...
export default TrailerTvSeries;
